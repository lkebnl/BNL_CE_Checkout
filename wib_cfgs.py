...
# input(3)
    ...
    def wib_vol_mon(self, femb_ids, sps=10):
        vms = ["CDVDDA", "CDVDDIO_HALF", "ADCRVDDD1P2", "ADCLVDDD1P2", "FERVDDP", "FELVDDP", "ADCRP25V_1_HALF",
               "ADCLP25V_1_HALF", "ADCRP25V_HALF",
               "ADCLP25V_HALF", "GND"]
        #0x19: u22, U26
        #x1b: U10,U18
        #0x1d: U20, U24
        #0x1f: U6,U14
        vols = [0x01, 0x03, 0x09, 0x0b, 0x11, 0x13, 0x19, 0x1b, 0x1d, 0x1f]
        vms_dict = {}
